...
class CAttackPoisoningLID(CAttackMixin, metaclass=ABCMeta):
    ...
    def __init__(self, classifier,
        ...
        super(CAttackPoisoningLID, self).__init__(
        ...
        self.lid_k = lid_k
        self.training_data_ndarray = training_data.X.tondarray()
        self.original_lid_values = None
    ...
    def get_lids(self, X, batch=None, k=10):
        lid_batch = self.mle_batch(X, batch, k=k)
        return lid_batch
    ...
    def run(self, x, y, ds_init=None, max_iter=1):
        ...
        if self.init_type == 'random':
            ...
            xc, yc, idx = self._rnd_init_poisoning_points()
        ...
        # calculate the LIDs
        lids = self.get_lids(self.training_data_ndarray, batch=None, k=self.lid_k)
        poison_indices = idx.tondarray()
        self.original_lid_values = lids[poison_indices]
        ...
        return y_pred, scores, CDataset(xc, yc), self._f_opt, poison_indices
